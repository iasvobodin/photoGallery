<script lang="ts">
	...
	onMount(() => {
		...
		window.ym(47422762, 'init', {
			clickmap: true,
			trackLinks: true,
			accurateTrackBounce: true
			// webvisor: true, // если нужен вебвизор
		});
	});
</script>
...
<svelte:head>
	...
	<meta name="twitter:image" content="https://image.svobodinaphoto.ru/1024_19-08-24-17-09-02.jpg" />
	<meta property="og:title" content="SvobodinaPhoto" />
	<meta property="og:type" content="website" />
	<meta property="og:image" content="https://image.svobodinaphoto.ru/1024_19-08-24-17-09-02.jpg" />
	...
	/>
	<meta property="vk:image" content="https://image.svobodinaphoto.ru/1024_19-08-24-17-09-02.jpg" />
